...
// Here's another nice usage:
// // Global Ajax Error/Success Handling, triggers sammy app event
// // $("#messages").ajaxError(function(event, request, settings){
// //  var send_error = settings.url;
// //  context.broadcast({'error':send_error});
// // });
...
(function($) {
  ...
  var Broadcast = {
    default_config: {
			// The default callback - rolls the div down, and then hides it again
